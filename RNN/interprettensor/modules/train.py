...
class Train():
    ...
    def compute_cost(self):
        ...
        if self.loss=='softmax_crossentropy':
        ...
        elif self.loss=='sparse_softmax_crossentropy':
            #Cross Entropy loss:
            with tf.name_scope('sparse_softmax_crossentropy'):
            ...
            print('Loss should be one of [softmax_crossentropy, sparse_softmax_crossentropy, sigmoid_crossentropy, MSE] ')
    ...
    def optimize(self):
        ...
        with tf.name_scope('train'):
            self.cost = tf.Print(self.cost, [self.cost], "self.cost: ")
